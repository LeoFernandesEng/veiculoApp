...
const VeiculoList = () => {
    ...
    return (
        <Container>
            <h1 className="my-4">Gerenciamento de Veículos</h1>
            <Card className="mb-4">
                <Card.Body>
                    <Form>
                        <Row className="mb-3">
                        ...
                        <Button onClick={handleFilter} className="me-2" variant="primary">Filtrar</Button>
                        ...
                        <tbody>
                            {veiculos.map((veiculo) => (
                                <tr key={veiculo.id}>
                                    ...
                                    <td>
                                        <Link to={`/veiculos/${veiculo.id}`} className="btn btn-primary me-2">Detalhes</Link>
                                        <Link to={`/veiculos/${veiculo.id}/edit`} className="btn btn-secondary me-2">Editar</Link>
            ...
            <Link to="/veiculos/create">
                <Button className="mt-4" variant="success">Adicionar Novo Veículo</Button>
            </Link>
        </Container>
    );
};
